...
const user_progress_resolver_1 = require("./user-progress.resolver");
...
exports.UserProgressModule = UserProgressModule = __decorate([
    (0, common_1.Module)({
        providers: [user_progress_service_1.UserProgressService, user_progress_resolver_1.UserProgressResolver],
    })
], UserProgressModule);
