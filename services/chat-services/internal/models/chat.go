...
// FileMetadata represents file attachment metadata
...
// PollData represents poll information
...
// UserPresence represents user online status and presence information
...
// GroupInfo represents group chat information
type GroupInfo struct {
	...
	Members     []GroupMember `json:"members" db:"members"`
	MaxMembers  int32         `json:"max_members" db:"max_members"`
	IsPrivate   bool          `json:"is_private" db:"is_private"`
	CreatedAt   time.Time     `json:"created_at" db:"created_at"`
	UpdatedAt   time.Time     `json:"updated_at" db:"updated_at"`
}

// CallInfo represents voice/video call information
