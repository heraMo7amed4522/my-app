...
import (
	...
	"chats-services/internal/config"
	"chats-services/internal/repository/postgres"
	"chats-services/internal/server"
	"chats-services/internal/service"
	"chats-services/pkg/database"
